...
| 条件 | 说明 |
|------|------|
| **⚠️ 强烈建议：独立使用者账户** | **请勿使用你的主账户！** 请在 IBKR 后台新创建一个**“使用者账户”（Secondary User）**，并**仅赋予只读权限（取消所有交易权限）**。这能从根本上保证你的资金安全。<br>👉 [点击查看：如何创建只读使用者账户的视频教程](/Users/qibaoba/Downloads/OpenClaw连上IBKR.mov) |
